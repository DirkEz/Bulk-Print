...
class MainWindow(QMainWindow):
    ...
    def show_manual(self) -> None:
        self.show_info_popup(
            "Help",
            "🖨️  Printer\n"
            "Kies de Windows-printer waar alle bestanden naartoe moeten.\n\n"
            "⚙️  Printerinstellingen\n"
            "Opent de Windows-instellingen van de gekozen printer, zoals papierformaat, lade of dubbelzijdig printen.\n\n"
            "🔢  Kopieen\n"
            "Bepaalt hoeveel keer elk bestand naar de printer wordt verzonden.\n\n"
            "📄  Orientatie\n"
            "Kies automatisch, staand of liggend voor PDF's en afbeeldingen.\n\n"
            "➕  Bestanden toevoegen\n"
            "Opent de bestandskiezer voor PDF-, Office- en afbeeldingsbestanden.\n\n"
            "📥  Slepen naar het venster\n"
            "Sleep bestanden direct in de app om ze toe te voegen.\n\n"
            "🗑️  Verwijderen\n"
            "De prullenbakknop haalt alleen dat ene bestand uit de lijst.\n\n"
            "🧹  Lijst leegmaken\n"
            "Verwijdert alle gekozen bestanden uit de app.\n\n"
            "🚀  Print starten\n"
            "Verzendt alle bestanden in de getoonde volgorde naar de printerwachtrij.\n\n"
            "⏹️  Annuleren\n"
            "Stopt na het bestand dat op dat moment bezig is.\n\n"
            "🔄  Updates zoeken\n"
